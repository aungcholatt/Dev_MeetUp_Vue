    ...
    <v-container>
      <v-sheet class="mx-auto mt-4" max-width="800">
        <v-row class="mb-1 justify-center ">
          <v-col cols="6">
            <v-btn rounded router to="/acct" color="purple darken-1" class="mr-2 mb-1 white--text">Explore Meetups</v-btn>
        ...
        <v-sheet row wrap class="mt-1 d-flex align-center flex-column ">
            <p class="text-info">Join Our Awesome Meetups!</p>
        </v-sheet>
    </v-container>
</template>
